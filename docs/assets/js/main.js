"use strict";(()=>{var ee=Object.defineProperty;var te=(r,e,t)=>e in r?ee(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var y=(r,e,t)=>te(r,typeof e!="symbol"?e+"":e,t);function H(){let r=document.querySelector(".nav-toggle"),e=document.querySelector(".site-nav");r&&e&&(r.addEventListener("click",()=>{let n=e.classList.toggle("site-nav--open");r.setAttribute("aria-expanded",String(n))}),document.addEventListener("click",n=>{!e.contains(n.target)&&!r.contains(n.target)&&(e.classList.remove("site-nav--open"),r.setAttribute("aria-expanded","false"))}),document.addEventListener("keydown",n=>{n.key==="Escape"&&e.classList.contains("site-nav--open")&&(e.classList.remove("site-nav--open"),r.setAttribute("aria-expanded","false"),r.focus())})),document.querySelectorAll(".nav-dropdown").forEach(n=>{let s=n.querySelector(".nav-dropdown__toggle");s&&(s.addEventListener("click",i=>{let a=s.querySelector(".nav-dropdown__caret");if(a&&a.contains(i.target)){i.preventDefault(),_(n);return}e&&getComputedStyle(e).flexDirection==="column"&&(i.preventDefault(),_(n))}),document.addEventListener("click",i=>{n.contains(i.target)||I(n)}),n.addEventListener("keydown",i=>{i.key==="Escape"&&I(n)}))});let t=window.location.pathname;document.querySelectorAll(".site-nav__link, .nav-dropdown__item").forEach(n=>{let s=n.getAttribute("href");if(s&&t.startsWith(s)&&s!=="/ai-coding/"){n.classList.add("site-nav__link--active");let i=n.closest(".nav-dropdown");i&&i.querySelector(".nav-dropdown__toggle")?.classList.add("site-nav__link--active")}})}function _(r){let e=r.classList.toggle("nav-dropdown--open");r.querySelector(".nav-dropdown__toggle")?.setAttribute("aria-expanded",String(e))}function I(r){r.classList.remove("nav-dropdown--open"),r.querySelector(".nav-dropdown__toggle")?.setAttribute("aria-expanded","false")}function q(){document.querySelectorAll(".accordion").forEach(e=>{let t=e.querySelector(".accordion__trigger"),n=e.querySelector(".accordion__content");if(!t||!n)return;let s=n.id||`accordion-${Math.random().toString(36).slice(2,9)}`;n.id=s,t.setAttribute("aria-controls",s),t.setAttribute("aria-expanded",e.classList.contains("accordion--open")?"true":"false"),n.setAttribute("role","region"),n.setAttribute("aria-labelledby",t.id||""),t.addEventListener("click",()=>{let i=e.classList.toggle("accordion--open");t.setAttribute("aria-expanded",String(i))}),t.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),t.click())})})}function B(){let r=document.querySelector(".matrix-table");if(!r)return;r.querySelectorAll("tbody tr[data-dimension]").forEach(t=>{let n=t.querySelectorAll(".matrix-cell"),s=t.querySelector(".matrix-dimension-header");if(!s)return;t.style.cursor="pointer",s.setAttribute("role","button"),s.setAttribute("aria-expanded","false"),s.setAttribute("tabindex","0");let i=()=>{let a=t.classList.toggle("matrix-row--expanded");s.setAttribute("aria-expanded",String(a)),n.forEach(l=>{l.classList.toggle("matrix-cell--expanded",a)})};t.addEventListener("click",i),s.addEventListener("keydown",a=>{(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),i())})})}function R(){document.querySelectorAll(".citation-list").forEach(e=>{let t=e.querySelector(".citation-list__title"),n=e.querySelector("ul");if(!t||!n)return;n.style.display="none",t.style.cursor="pointer",t.setAttribute("role","button"),t.setAttribute("aria-expanded","false"),t.setAttribute("tabindex","0");let s=()=>{let i=n.style.display==="none";n.style.display=i?"":"none",t.setAttribute("aria-expanded",String(i))};t.addEventListener("click",s),t.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),s())})})}function N(){document.querySelectorAll("[data-filterable]").forEach(e=>{let t=e.querySelectorAll("[data-filter-text]");if(t.length<5)return;let n=document.createElement("input");n.type="text",n.placeholder="Filter...",n.className="filter-input",n.setAttribute("aria-label","Filter items"),n.addEventListener("input",()=>{let s=n.value.toLowerCase().trim();t.forEach(i=>{let a=i.getAttribute("data-filter-text")?.toLowerCase()||"";i.style.display=!s||a.includes(s)?"":"none"})}),e.parentElement?.insertBefore(n,e)})}function Q(){se()}function se(){let r=document.querySelector(".matrix-table");if(!r)return;let e="matrix-expanded-cells";r.addEventListener("click",t=>{t.target.closest(".matrix-cell__summary")&&requestAnimationFrame(()=>{let s=[];r.querySelectorAll(".matrix-cell--expanded").forEach((i,a)=>{s.push(String(a))});try{localStorage.setItem(e,JSON.stringify(s))}catch{}})});try{let t=localStorage.getItem(e);if(t){let n=JSON.parse(t),s=r.querySelectorAll(".matrix-cell");n.forEach(i=>{let a=s[Number(i)];if(a){a.classList.add("matrix-cell--expanded");let l=a.querySelector(".matrix-cell__summary");l&&l.setAttribute("aria-expanded","true")}})}}catch{}}function D(r,e,t=320){let n=t/2,s=t/2,i=t*.38,a=t*.47,l=r.length,u=2*Math.PI/l,m=-Math.PI/2,c=[1,2,3,4],h="rgba(255,255,255,0.08)",o="rgba(255,255,255,0.12)",v="#6dacf0",d="rgba(109,172,240,0.2)",g=`<svg viewBox="0 0 ${t} ${t}" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Competence radar chart showing scores across ${l} dimensions">`;for(let p of c){let f=p/4*i,b=[];for(let x=0;x<l;x++){let S=m+x*u;b.push(`${n+f*Math.cos(S)},${s+f*Math.sin(S)}`)}g+=`<polygon points="${b.join(" ")}" fill="none" stroke="${h}" stroke-width="1"/>`}for(let p=0;p<l;p++){let f=m+p*u,b=n+i*Math.cos(f),x=s+i*Math.sin(f);g+=`<line x1="${n}" y1="${s}" x2="${b}" y2="${x}" stroke="${o}" stroke-width="1"/>`}let E=[];for(let p=0;p<l;p++){let f=m+p*u,b=r[p].score/4*i;E.push(`${n+b*Math.cos(f)},${s+b*Math.sin(f)}`)}g+=`<polygon points="${E.join(" ")}" fill="${d}" stroke="${v}" stroke-width="2"/>`;for(let p=0;p<l;p++){let f=m+p*u,b=r[p].score/4*i,x=n+b*Math.cos(f),S=s+b*Math.sin(f);g+=`<circle cx="${x}" cy="${S}" r="4" fill="${v}"/>`}for(let p=0;p<l;p++){let f=m+p*u,b=n+a*Math.cos(f),x=s+a*Math.sin(f),S="middle";Math.cos(f)<-.1?S="end":Math.cos(f)>.1&&(S="start");let Z=Math.sin(f)>.1?"1em":Math.sin(f)<-.1?"-0.3em":"0.35em";g+=`<text x="${b}" y="${x}" text-anchor="${S}" dy="${Z}" fill="#8891a5" font-size="11" font-family="'DM Sans',sans-serif">${r[p].shortLabel}</text>`}let L=r.reduce((p,f)=>p+f.score,0)/l;g+=`<text x="${n}" y="${n-8}" text-anchor="middle" fill="#e4e6ed" font-size="24" font-weight="600" font-family="'DM Sans',sans-serif">${L.toFixed(1)}</text>`,g+=`<text x="${n}" y="${n+12}" text-anchor="middle" fill="#8891a5" font-size="11" font-family="'DM Sans',sans-serif">avg score</text>`,g+="</svg>",e.innerHTML=g}var w="ccc-assessment";function ne(){try{let r=localStorage.getItem(w);return r?JSON.parse(r):null}catch{return null}}function ie(r){try{localStorage.setItem(w,JSON.stringify(r))}catch{}}function re(r){return r<1.5?1:r<2.25?2:r<3?3:r<3.5?4:5}var z={1:{title:"Operator",slug:"operator"},2:{title:"Structured Collaborator",slug:"structured-collaborator"},3:{title:"Environment Builder",slug:"environment-builder"},4:{title:"Workflow Engineer",slug:"workflow-engineer"},5:{title:"Agentic Systems Expert",slug:"agentic-systems-expert"}};function O(){let r=document.getElementById("assessment-app");if(!r)return;let e=document.getElementById("assessment-data"),t=document.getElementById("dimensions-meta");if(!e||!t)return;let n,s;try{n=JSON.parse(e.textContent||"[]"),s=JSON.parse(t.textContent||"[]")}catch{return}if(n.length===0||s.length===0)return;let i=new Map;for(let l of n){let u=i.get(l.dimensionId)||[];u.push(l),i.set(l.dimensionId,u)}let a=ne();if(a){oe(r,a,s,i,n);return}F(r,s,i)}function F(r,e,t){A(r,{answers:{},currentDimIndex:0},e,t)}function A(r,e,t,n){let s=t[e.currentDimIndex],i=n.get(s.id)||[],a=t.length,l=e.currentDimIndex+1,u=l/a*100;r.innerHTML=`
  ...
  `,r.querySelectorAll(".assess-choice").forEach(o=>{o.addEventListener("click",()=>{let v=o.getAttribute("data-qid"),d=Number(o.getAttribute("data-value"));e.answers[v]=d,o.closest(".assess-question").querySelectorAll(".assess-choice").forEach(p=>p.classList.remove("assess-choice--selected")),o.classList.add("assess-choice--selected");let E=i.every(p=>e.answers[p.id]!==void 0),L=r.querySelector(".assess-nav__next");L&&E&&(L.disabled=!1)})});let m=r.querySelector(".assess-nav__next");m&&m.addEventListener("click",()=>{e.currentDimIndex<t.length-1?(e.currentDimIndex++,A(r,e,t,n)):ae(r,e,t,n)});let c=r.querySelector(".assess-nav__prev");if(c&&c.addEventListener("click",()=>{e.currentDimIndex--,A(r,e,t,n)}),i.every(o=>e.answers[o.id]!==void 0)){let o=r.querySelector(".assess-nav__next");o&&(o.disabled=!1)}}function ae(r,e,t,n){let s={};for(let m of t){let h=(n.get(m.id)||[]).map(o=>e.answers[o.id]||1);s[m.id]=h.reduce((o,v)=>o+v,0)/h.length}let i=Object.values(s).reduce((m,c)=>m+c,0)/t.length,a=re(i),l=z[a],u={completedAt:new Date().toISOString(),answers:e.answers,dimensionScores:s,estimatedLevel:a,version:1};ie(u),P(r,u,t,n)}function oe(r,e,t,n,s){let i=new Date(e.completedAt).toLocaleDateString();r.innerHTML=`
  ...
  `;let h=document.getElementById("radar-chart");h&&D(t.map(o=>({label:o.name,shortLabel:o.shortName,score:e.dimensionScores[o.id]||1})),h),document.getElementById("retake-from-results")?.addEventListener("click",()=>{localStorage.removeItem(w),location.reload()})}var K="ccc-quiz-seen",j="ccc-quiz-history";function W(){try{return JSON.parse(localStorage.getItem(K)||"[]")}catch{return[]}}function le(r){try{let e=W(),t=[...new Set([...e,...r])];localStorage.setItem(K,JSON.stringify(t.slice(-200)))}catch{}}function ce(r){try{let e=JSON.parse(localStorage.getItem(j)||"[]");e.push(r),localStorage.setItem(j,JSON.stringify(e.slice(-50)))}catch{}}function J(r){let e=[...r];for(let t=e.length-1;t>0;t--){let n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}return e}function de(r,e,t,n){let s=r;e!=="all"&&(s=s.filter(m=>m.levelId===e)),t!=="all"&&(s=s.filter(m=>m.dimensionId===t));let i=new Set(W()),a=s.filter(m=>!i.has(m.id)),l=s.filter(m=>i.has(m.id));return[...J(a),...J(l)].slice(0,n)}function G(){let r=document.getElementById("quiz-app");if(!r)return;let e,t,n;try{e=JSON.parse(document.getElementById("quiz-data")?.textContent||"[]"),t=JSON.parse(document.getElementById("quiz-dimensions")?.textContent||"[]"),n=JSON.parse(document.getElementById("quiz-levels")?.textContent||"[]")}catch{return}e.length!==0&&Y(r,e,t,n)}function Y(r,e,t,n){r.innerHTML=`
  ...
  `,document.getElementById("start-quiz").addEventListener("click",()=>{let s=Number(document.getElementById("qcount").value),i=document.getElementById("qlevel").value,a=document.getElementById("qdim").value,l=de(e,i,a,s);if(l.length===0){r.innerHTML='<p class="text-muted">No questions match your filters. Try different settings.</p><button class="assess-nav__btn mt-md" id="back-config">Back</button>',document.getElementById("back-config").addEventListener("click",()=>Y(r,e,t,n));return}ue(r,l,e,t,n)})}function ue(r,e,t,n,s){let i=[],a=0;function l(){let u=e[a],m=a+1,c=e.length,h=m/c*100;r.innerHTML=`
    ...
    `,r.querySelectorAll(".assess-choice").forEach(o=>{o.addEventListener("click",()=>{let v=Number(o.getAttribute("data-value"));i.push({questionId:u.id,value:v,question:u}),r.querySelectorAll(".assess-choice").forEach(g=>{g.classList.remove("assess-choice--selected"),g.disabled=!0}),o.classList.add("assess-choice--selected");let d=document.getElementById("quiz-feedback");d.classList.remove("hidden"),d.innerHTML=`
        ...
        `,document.getElementById("quiz-next").addEventListener("click",()=>{a++,a<e.length?l():me(r,i,t,n,s)})})})}l()}function me(r,e,t,n,s){le(e.map(c=>c.questionId));let i=new Map;for(let c of e){let h=c.question.dimensionId,o=i.get(h)||{total:0,count:0};o.total+=c.value,o.count++,i.set(h,o)}let a=e.reduce((c,h)=>c+h.value,0)/e.length,l=new Map;for(let c of e)if(c.value<=2)for(let h of c.question.studyLinks){let o=h.href,v=l.get(o)||{link:h,count:0};v.count++,l.set(o,v)}let u=[...l.values()].sort((c,h)=>h.count-c.count).slice(0,8),m=[...i.entries()].map(([c,{total:h,count:o}])=>{let v=n.find(d=>d.id===c);return{id:c,name:v?.shortName||c,avg:h/o}}).sort((c,h)=>c.avg-h.avg);ce({completedAt:new Date().toISOString(),questionCount:e.length,averageScore:Math.round(a*100)/100,dimensionScores:Object.fromEntries(m.map(c=>[c.id,Math.round(c.avg*100)/100]))}),r.innerHTML=`
  ...
  `,document.getElementById("quiz-restart").addEventListener("click",()=>{location.reload()})}var he="ccc-assessment",ge="ccc-quiz-history";function ve(){try{return JSON.parse(localStorage.getItem(he)||"null")}catch{return null}}function pe(){try{return JSON.parse(localStorage.getItem(ge)||"[]")}catch{return[]}}function U(){let r=document.getElementById("study-guide-app");if(!r)return;let e,t;try{e=JSON.parse(document.getElementById("study-dimensions")?.textContent||"[]"),t=JSON.parse(document.getElementById("study-levels")?.textContent||"[]")}catch{return}let n=ve(),s=pe();if(!n&&s.length===0){fe(r);return}ye(r,n,s,e,t)}function fe(r){let e=X();r.innerHTML=`
  ...
  `}function k(r,e){let t=r.avg/4*100;return`
